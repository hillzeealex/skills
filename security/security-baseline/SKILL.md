...
description: Use when starting or hardening a Node/TypeScript backend that stores personal data — to set up field-level PII encryption at rest, tenant-scoping against IDOR, upload validation, log redaction, CORS/error fail-closed, and to verify the result. Triggers: "secure my backend", "encrypt PII at rest", "add security baseline", "GDPR/nLPD data protection", "harden this API".
---
